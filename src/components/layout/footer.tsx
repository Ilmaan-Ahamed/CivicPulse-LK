...
=======
              <div className="w-8 h-8 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center shadow-md shadow-emerald-500/5">
...
=======
                className="inline-flex items-center gap-1.5 text-slate-300 hover:text-emerald-400 transition-all duration-300 font-semibold"
>>>>>>> 7548f6d (Update CivicPulse development features)
              >
