    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1 max-w-3xl">
          Help filter out false or exaggerated complaints. Confirm infrastructure reports near you to earn trust points
          and escalate verified issues to Divisional Secretariat offices.
        </p>
      </div>
      ...
      {unverifiedReports.length === 0 ? (
        <div className="p-12 text-center rounded-3xl bg-slate-900/40 border border-slate-800 space-y-3">
          ...
          <p className="text-xs text-slate-400">All submitted reports in your area have been verified or triaged.</p>
        </div>
      ) : (
