    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto space-y-8">
      ...
      <div className="p-6 rounded-3xl bg-slate-900/60 border border-slate-800 space-y-3">
        <div className="flex items-center justify-between">
          <span className="font-mono text-xs text-teal-400 font-bold">{report.referenceNo}</span>
          <span className="text-xs text-slate-400">{CATEGORY_LABELS[report.category] || report.category}</span>
        </div>
